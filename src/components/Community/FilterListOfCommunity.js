...
const FilterListOfCommunity = ({ filterText, onFilter, onClear }) => (
  


  <div className="row mt-2" style={{width:"100%",marginLeft:"0",padding:"0px 10px",position:"absolute",top:"-100px"}} >

  <div className="col-md-4 d-flex flex-row" style={{ height: "100%", padding: "0px"}}>
  <h4 style={{color:"black",fontWeight:"bold", marginTop:"7px"}} >List of Community</h4>
  </div>
...
export default FilterListOfCommunity;
