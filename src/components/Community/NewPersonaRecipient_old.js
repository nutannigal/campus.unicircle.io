    ...
    <div>
      ...
      <div className="recipient_class" style={{ marginTop: "0px", height: "100%", padding: "0" }}>
        ...
        <input
          ...
          value="Invite"
          // style={{ fontWeight: "500", border: "none", color: "#ffffff", width:"130px", borderRadius: "3px", marginLeft: "auto", backgroundColor: "#000000", padding: "7px 20px", fontSize: "12PX", boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)", marginBottom: "20px",marginRight:"5px" }}
        />
        </div>
