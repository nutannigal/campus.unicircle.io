...
const FilterComponentMarketPlace = ({ filterText, onFilter, onClear }) => (
  ...
  <div className="row mt-2" style={{ width: "100%", marginLeft: "0", paddingRight: "10PX" }} >
    <div className="col-md-6 d-flex flex-row" style={{ height: "100%", padding: "0px 5px" }}>
      <h4 style={{ color: "black", fontWeight: "bold", marginTop: "7px" }} className="ml-auto" >MARKETPLACE</h4>
    ...
    <div className="col-md-3">
      <div style={{ marginLeft: "20px", marginTop: "0px", padding: "0" }}>
        ...
        <Link to="/sellItem">
          ...
          <button
            type="button"
            className="d-flex buttonContainer stud_button"
          ...
          >
            ...
            <div className="button-label" style={{ marginLeft: "5px", fontSize: "12.25PX", fontWeight: "400", fontFamily: "Poppins" }}>Sell Item</div>
          </button>
...
export default FilterComponentMarketPlace;
