...
const FilterComponentPolls = ({ filterText, onFilter, onClear }) => (
  ...
  <h4 style={{color:"black",fontWeight:"bold", marginTop:"7px"}} >List of polls created</h4>
  </div>
      ...
      <div style={{ marginTop: "0px", padding: "0" }}>
        ...
        <Link to="/createPoll">
          ...
          >
            ...
            <div style={{ marginLeft: "5px", fontSize: "12.25PX", fontWeight: "400", fontFamily: "Poppins" }}>Create Poll</div>
          </button>
...
export default FilterComponentPolls;
